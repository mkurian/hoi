...
/**
 * Entry point for Hoi application
 * @author mkurian
 *
 */
public class HoiServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 218813212964425810L;
	public static final String appKey = "a380e713-4123-4df3-9d50-73025906013f";
	public static final String pubKey = "8d8d7b68-a80f-40e6-a4e3-83929ab965a5";
	
	private static Logger logger = Logger.getLogger(HoiServlet.class.getName());
	/*
	...
	private static void processRequest(HttpServletRequest httpRequest,
		...
		HoiApp app = new HoiApp();		
		String response = app.processRequest(text, protocol, mobileHash, id, verifyid);
